namespace Data_Layer.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Ad = c.String(),
                        OduncKitaplar_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.OduncKitap", t => t.OduncKitaplar_Id)
                .Index(t => t.OduncKitaplar_Id);
        ...
        {
            DropForeignKey("dbo.Uye", "OduncKitaplar_Id", "dbo.OduncKitap");
            ...
            DropIndex("dbo.Uye", new[] { "OduncKitaplar_Id" });
